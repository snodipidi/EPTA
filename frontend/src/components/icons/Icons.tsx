...
export function AvatarIcon({ size = 40, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ImageUploadIcon({ size = 22, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function RepostIcon({ size = 18, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
